...
# Set up phpMyAdmin authentication
RUN echo 'phpmyadmin phpmyadmin/dbconfig-install boolean true' | debconf-set-selections \
    && echo 'phpmyadmin phpmyadmin/app-password-confirm password your_password' | debconf-set-selections \
    && echo 'phpmyadmin phpmyadmin/mysql/admin-pass password your_password' | debconf-set-selections \
    && echo 'phpmyadmin phpmyadmin/mysql/app-pass password your_password' | debconf-set-selections \
